...
/**
 * Get group reservations for a sanction (Rhythmic, Acro, T&T, GFA)
 *
 * @see https://api.usagym.org/v4/sanction/{sanctionId}/reservations/group
 */
class GetGroupsRequest extends Request
{
    ...
    {
        return "/sanction/{$this->sanctionId}/reservations/group";
    }
    ...
    public function createDtoFromResponse(Response $response): array
    {
        ...
        return array_map(
            fn(array $item) => GroupReservation::fromArray($item),
            $reservations
        );
    }
}
